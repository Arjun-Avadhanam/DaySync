...
private val guidePages = listOf(
    GuidePage(
        ...
        features = listOf(
            ...
            "Weekly Insights card (top) shows your Claude-generated weekly summary from Notion",
            "Cloud sync at the bottom — tap Sync Now to push all data to Supabase",
            "Settings gear icon (top-right) to manage permissions, configure timezone/currency/sync times, and view this guide",
        ),
    ),
    GuidePage(
        ...
        features = listOf(
            ...
            "Charts for steps, heart rate, sleep, and workout trends (7 Days / 30 Days / Custom range) — tap any bar or point to see exact values",
            "Period statistics: average sleep, weight, water, and calorie deficit/burned",
            "Workout by Type filter — select a type and optionally a sub-type to see per-workout charts",
            "Calorie deficit/surplus (Health burned − Nutrition consumed) when the diet is unlocked; shows calories burned when locked",
        ),
    ),
    GuidePage(
        ...
        features = listOf(
            ...
            "Scan nutrition labels with AI (Gemini, with OCR+Groq fallback) — take a photo, get auto-extracted data",
            "Daily meal tracking with breakfast/lunch/dinner/snacks",
            "Lock the diet (🔒 in the top bar) to make daily food read-only once your diet is settled — water stays editable",
            "Meal templates for quick repeat entries",
            "Daily summary with calories, protein, carbs, fat, sugar, and water",
            "History view with 7/30/90 day or custom date range filtering",
        ),
    ),
    GuidePage(
        ...
        features = listOf(
            ...
            "Monthly totals with category breakdown chips, or select a custom date range",
    ...
    GuidePage(
        ...
        features = listOf(
            ...
            "Star events to add to the Watchlist tab — add Watchnotes to record your thoughts on each match",
    ...
    GuidePage(
        ...
        features = listOf(
            ...
            "Search powered by OMDb, Google Books, Jikan (MAL), Steam, MusicBrainz, OpenLibrary",
    ...
    GuidePage(
        ...
        title = "AI Assistant",
        features = listOf(
            "Tap the sparkle FAB on any screen to open the AI chat — drag it to reposition if it blocks content",
            "Ask questions about your data: health trends, expenses, nutrition, workouts, calorie deficit",
            "AI has full context: steps, sleep, weight, meals (individual items), calories burned/consumed, deficit, expenses, journal, sports, media",
