...
class DataContextBuilder(
    ...
    suspend fun buildContext(startDate: LocalDate, endDate: LocalDate): String {
        ...
        val nutritionSummaries = nutritionSummaryDao.getByDateRange(startStr, endStr)
        val expenses = expenseDao.getByDateRange(startStr, endStr)
        val categoryTotals = expenseDao.getTotalByCategory(startStr, endStr)
        val journalEntries = journalEntryDao.getByDateRange(startStr, endStr)
        val sportEvents = sportEventDao.getEventsByDateRange(startMillis, endMillis)
